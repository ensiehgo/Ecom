     ...
     const handleToken = async(token)=>{
        ...
        if(status==='success'){
            ...
            toast.success('Your order has been placed successfully', {
              ...
              //deleting docs from cart after purchase has been successfull
            ...
            {cartProducts.length > 0 && (
                <div className='container-fluid'>
                    ...
                    <div className='summary-box'>
                        ...
                        <br></br>
                        <StripeCheckout
                            stripeKey='pk_test_51K5M9KAYmanOMt5wedgmoYTPzjvkIPm4H31DOlnwxWAwwhimyyJ8cYSVbPefmrqFXkQlxtZCLQZNkziMdYjEsGxP00fbf6qNxX'
                            token={handleToken}
                            billingAddress
                            shippingAddress
                            name='All Products'
